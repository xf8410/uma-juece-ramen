...
[1m[91merror[0m[1m: unused import: `Trainer`[0m
  [1m[94m--> [0msrc/lib.rs:18:11
   [1m[94m|[0m
[1m[94m18[0m [1m[94m|[0m     Game, Trainer,
   [1m[94m|[0m           [1m[91m^^^^^^^[0m
   [1m[94m|[0m
...
[1m[91merror[0m[1m: unused import: `serde::de::Error`[0m
   [1m[94m--> [0msrc/lib.rs:101:9
    [1m[94m|[0m
[1m[94m101[0m [1m[94m|[0m     use serde::de::Error;
    [1m[94m|[0m         [1m[91m^^^^^^^^^^^^^^^^[0m

[1m[91merror[0m: could not compile `uma-jni` (lib) due to 2 previous errors
[1m[33mwarning[0m: build failed, waiting for other jobs to finish...
[1m[91merror[0m: could not compile `uma-jni` (lib test) due to 2 previous errors
```
